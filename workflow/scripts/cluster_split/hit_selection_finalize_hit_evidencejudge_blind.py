...
import external_multitool_finalize_augmented_blind as phase30
from hit_selection_train_hit_evidencejudge import canonical_full, parse_enzyme_transfers
...
PROTOCOL = ROOT / {
    ...
    32: "PROJECT/Phase32_tool_training_clean_external_blind_protocol.md",
}[PHASE_ID]
...
def main() -> None:
    ...
    if PHASE_ID == 32:
        ...
        tool_training_resource_unchanged = sha256(
            ROOT / "data/interim/hit_selection_tool_training_homology/tool_training_unique.fasta"
        ...
        if (
            ...
            raise RuntimeError("Phase32 protocol, scripts or tool-training inventory changed after freeze")
    required = [
    ...
    lock = {
        ...
        "tool_training_fasta_sha256": (
            ...
            if PHASE_ID == 32 else None
        ),
        "protocol_lock_sha256": sha256(protocol_lock_path) if PHASE_ID == 32 else None,
    }
    checks = {
        ...
        "phase32_frozen_scripts_unchanged": PHASE_ID != 32 or frozen_scripts_unchanged,
        "phase32_tool_training_resource_unchanged": PHASE_ID != 32 or tool_training_resource_unchanged,
