...
if PHASE_ID not in {27, 28, 30, 31, 32}:
...
TOOL_TRAINING_FASTA = ROOT / "data/interim/hit_selection_tool_training_homology/tool_training_unique.fasta"
...
def finalize() -> None:
    ...
    for level, column in [("EC_L3", "ec_l3_label_eligible"), ("EC_L4", "ec_l4_label_eligible")]:
        ...
        required_queries = 120 if PHASE_ID == 32 and level == "EC_L3" else 50
        required_clusters = 50 if PHASE_ID == 32 and level == "EC_L3" else 20
        power_rows.append({
    ...
    checks = [
        ...
        ("all_survivors_tool_training_independent", PHASE_ID != 32 or bool(survivors["tool_training_homology_independent"].all()), len(survivors)),
